...
public class Board {
    ...
    public void spacePressed(){
        for (Entity entity : allEntityList) {
            if (entity instanceof BreakingBlock){
                BreakingBlock pcushingBlock = (BreakingBlock) entity;
